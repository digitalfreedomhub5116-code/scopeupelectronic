...
const LOCAL_STORAGE_PRODUCTS_KEY = 'scope_internationals_products'
...
export const useCartStore = create((set, get) => ({
  ...
  addProduct: (newProduct) => {
    ...
    const productWithDefaults = {
      ...
      dimensions: newProduct.dimensions || 'Standard Export Dimensions',
      ...
      pack: newProduct.pack || 'Bulk Export Carton',
      durability: newProduct.durability || 'Industrial Grade Tested Reliability',
      features: newProduct.features || [
        'CE and FCC certified for global export compliance',
        'Multi-stage automated QC verified hardware reliability',
        'International standard export packaging',
      ],
      reviews: [],
      ...newProduct,
    }
