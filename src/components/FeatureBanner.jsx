import { ShieldCheck, Cpu, Sparkles, Truck } from 'lucide-react'
...
export default function FeatureBanner() {
  ...
  return (
    <section id="craftsmanship" ref={ref} className="relative overflow-hidden py-16 sm:py-24 bg-[#F4EFEA] border-y border-[#E7E2D9]">
      <div
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-16">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-[#E7E2D9] bg-white shadow-xl shadow-stone-900/5">
                ...
                <div className="absolute bottom-5 left-5 right-5 text-white">
                  ...
                  <p className="text-xs text-stone-200 mt-0.5">
                    Automated acoustic calibration & 72-hour thermal stress burn-in testing.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1C1917] tracking-tight leading-tight mt-4">
              Engineered for Unrivaled Performance
            </h2>
            ...
            <div className="mt-6 space-y-3.5 max-w-xl">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-serif text-sm font-bold text-[#1C1917]">
                    Comprehensive 2-Year Direct Warranty
                  </h4>
                  <p className="text-xs text-[#78716C] mt-0.5">
                    Every device arrives factory sealed with a verified serial number and complete 24-month warranty support.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-serif text-sm font-bold text-[#1C1917]">
                    Complimentary Express Doorstep Delivery
                  </h4>
                  <p className="text-xs text-[#78716C] mt-0.5">
                    Dispatched in custom protective unboxing packaging with full real-time tracking directly to your door.
                  </p>
                </div>
              </div>
            </div>
